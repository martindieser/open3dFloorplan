...
- TODO: analizar porque no se adoptan las IDS propias que hay en kotklin para los objetos del proyecto. -> Eran proyectos viejos guardados en ROOM , nada en el floorplan.


- se modificó del original:
 - filtrado de heuristicas
- se elimino completamente
 - curaciones en las fotos
 - report details screen
 - camera vieja / reemplazado por recording

- agregar una forma de especificar altura dentro del posicionamiento en la forma 2d, por ejemplo para poner un medicamento arriba de la mesa
